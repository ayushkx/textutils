...
export default function About() {
    ...
    const [myBtn , setmyBtn] = useState('btn btn-dark my-3') ; 
    ...
    return (
        <div>
            <div className="accordion container" id="accordionExample" style = {myStyle} >
                ...
                <div>
                     <button type="button"  className={myBtn} onClick ={handleMode}>{myText}</button>
                </div>
            </div>
        </div>
    )
